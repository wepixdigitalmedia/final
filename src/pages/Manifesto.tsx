...
const chapters = [
  ...
  { id: "fashion-dna", title: "Fashion is in Our DNA", content: (<>We're from <TirupurTooltip /> — literally the textile capital of India. We grew up around garment factories, fabric markets, and people who stitch masterpieces with their hands. We understand fashion brands at a molecular level: the margins that keep you up at night, the seasonal inventory pressure, the Instagram algorithm that changes every Tuesday, and the pressure of launching a new collection when you're not sure if anyone will buy. We get it because we've lived it.</>) },
        ...
        <section className="gsap-hero-section py-24 md:py-32 border-b border-border">
          <div className="container max-w-3xl">
            ...
            <h1 className="gsap-hero-title font-display text-4xl md:text-5xl lg:text-6xl font-semibold opacity-0">
              What we believe in. (Warning: strong opinions ahead)
            </h1>
