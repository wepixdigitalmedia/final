...
const chapters = [
  ...
  { icon: BookOpen, num: "02", title: "How We Got Here", desc: (<>Two guys from <TirupurTooltip />, a laptop, and an unreasonable amount of ambition. From managing ₹10K ad budgets to ₹2Cr+ — here's the full, unfiltered story.</>)  },
  ...
  { icon: Globe, num: "08", title: "Remote & Office Culture", desc: (<>HQ in <TirupurTooltip />, office in Bangalore, team members across India and UAE. We don't care where you sit — we care about what you ship.</>)  },
