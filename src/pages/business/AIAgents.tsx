...
export default function AIAgents() {
  ...
  return (
    <Layout>
      ...
      <CTABanner headline="Ready to deploy your AI army? 🤖" subtext="Book a consultation. We'll discuss your use case and show you exactly how an AI agent would work for your business." ctaLabel="Book a Consultation" ctaHref="https://cal.com" />
    </Layout>
  );
}
